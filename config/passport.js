...
module.exports = function(passport) {
                    ...
                    User.findOne({
                        ...
                        if (user) {
                            ...
                            if (!user.tumblr.token) {
                                ...
                                user.tumblr.name = profile.username;
                                // user.tumblr.email = profile.emails[0].value;
                                user.tumblr = ((user.username == "") ? profile.username : user.username);
                            ...
                            newUser.tumblr.name = profile.username;
                            // newUser.tumblr.email = profile.emails[0].value;
                    ...
                    User.findOne({
                        ...
                        if (user) {
                            ...
                            if (!user.facebook.token) {
                                ...
                                user.username = ((user.username == "") ? profile.name.givenName + ' ' + profile.name.familyName : user.username);
                                user.save(function(err) {
                                    if (err)
                                        throw err;
                                    return done(null, user);
                    ...
                    User.findOne({
                        ...
                        if (user) {
                            ...
                            if (!user.twitter.token) {
                                ...
                                user.imageURL = ((user.imageURL == "") ? profile._json.profile_image_url : user.imageURL);
                                user.save(function(err) {
                                    if (err)
                                        throw err;
                                    return done(null, user);
    ...
    passport.use(new GoogleStrategy({
        ...
        function(req, token, refreshToken, profile, done) {
            req.session.gapiCode = req.query.code;
                    ...
                    User.findOne({
                        ...
                        if (user) {
                            ...
                            if (!user.google.token) {
                                ...
                                user.username = ((user.username == "") ? profile.displayName : user.username);
                                user.save(function(err) {
                                    if (err)
                                        throw err;
                                    return done(null, user);
